...
class FormationPageState extends State<FormationPage> {
  ...
  final String url = 'http://192.168.1.11:8085/FORMATION-SERVER/formations';
  ...
  DataRow? getRow(int index) {
    ...
    if (index < _rowCount) {
      return DataRow.byIndex(index: index, cells: <DataCell>[
        ...
        DataCell(Text("${_formations[index].description!}")),
        DataCell(Text("${_formations[index].category!}")),
        /*DataCell(IconButton(
